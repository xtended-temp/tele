...
public class VolumeDialogImpl implements VolumeDialog {
    ...
    private void addStreamButton(VolumeRow row, int stream, int iconRes, int iconMuteRes) {
        ...
        if(stream == AudioManager.STREAM_MUSIC && isMediaShowing ||
            stream == AudioManager.STREAM_RING && isRingerShowing ||
    ...
    private void addExistingRows() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if(button.stream == AudioManager.STREAM_MUSIC && isMediaShowing ||
                button.stream == AudioManager.STREAM_RING && isRingerShowing ||
